...
ChatLogic::~ChatLogic()
{
    //// STUDENT CODE
    ////
    std::cout << "ChatLogic Duestuctor" << std::endl;
    // delete chatbot instance
    // delete _chatBot;

    /*   
        comment out this part 
        std::unique_ptr will take care of the object's deletion
    */
    ...
    /* 
        No need to delete edges or nodes, as they are now managed by unique ptr
    */
